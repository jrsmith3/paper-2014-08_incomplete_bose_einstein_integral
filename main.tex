...
First, the upper incomplete Bose-Einstein integral will be calculated -- that is, with limits from $E_{A}$ to $\infty$. The resulting expression will be used to calculate the incomplete Bose-Einstein integral given in Eq. \ref{eq:54} from $E_{A}$ to $E_{B}$.
